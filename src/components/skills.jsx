    ...
    <section id="skills" className="w-full z-10 pt-15 mt-30">
      ...
      <div className="max-w-4xl mx-auto flex flex-wrap gap-6 justify-center">
        {skills.map((s, index) => (
          <div
            key={index}
            className="reveal flex flex-col items-center justify-center gap-3 text-center bg-[#081c29] border border-[#0e2f45] w-[140px] h-[130px] rounded-2xl shadow-md hover:scale-105 hover:border-[#2ef] transition-transform duration-300 card-shadow"
          >
